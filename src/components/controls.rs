...
pub fn Controls() -> Element {
    ...
    rsx! {
      div {
        class: "flex flex-col gap-6 bg-gradient-to-br from-slate-50 to-slate-100 max-sm:overflow-scroll max-sm:w-full shadow-lg rounded-xl p-6 w-1/4 relative border border-slate-200",
        ...
        div {
            ...
            label {
          class: "text-sm font-medium text-slate-600 flex items-center gap-2",
        ...
        div {
            class: "flex mt-auto flex-col gap-3 pt-6 border-t border-slate-300",
            label {
          class: "text-sm font-medium text-slate-600 flex justify-between items-center",
          span {
          ...
          span {
              class: "px-2 py-1 bg-blue-100 text-blue-600 rounded-md text-xs font-semibold",
          ...
          div {
              class: "absolute top-6 left-0 w-full flex justify-between text-xs text-slate-400",
              span { "Faster" }
              span { "Slower" }
          }
            }
        ...
        div {
          class: "space-y-6 pt-4 border-slate-200",
